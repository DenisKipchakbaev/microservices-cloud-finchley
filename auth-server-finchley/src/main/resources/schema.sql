...
INSERT INTO users(user_name,password,enabled) VALUES ('john.carnell','{bcrypt}$2a$10$arfMouXG4dLAF12KeJFWP.0z9P2vgQtmlAOtlced2x2.XBzpE6OkK', true);
INSERT INTO users(user_name,password,enabled) VALUES ('william.woodward','{bcrypt}$2a$10$1zjqCF4h3QBM8Tvm7bo8tuaPGkhmuVkNwJLGxxtWCS6Tc8C472Opa', true);
